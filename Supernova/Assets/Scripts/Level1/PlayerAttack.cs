	...
	void Fire()
	{
		...
		switch (faceDir)
		{
			case FaceDirection.Up:
				...
				GameObject go1 = Instantiate(bullet[0], new Vector3(this.transform.position.x, this.transform.position.y + 0.5f, this.transform.position.z), Quaternion.identity);
				go1.GetComponent<Bullet_V2>().dir = FaceDirection.Up;
				break;

			case FaceDirection.Down:
				anim.SetTrigger("DownAttack");
				GameObject go2 = Instantiate(bullet[1], new Vector3(this.transform.position.x, this.transform.position.y - 0.5f, this.transform.position.z), Quaternion.identity);
				go2.GetComponent<Bullet_V2>().dir = FaceDirection.Down;
				break;

			case FaceDirection.Left:
				anim.SetTrigger("LeftAttack");
				GameObject go3 = Instantiate(bullet[2], new Vector3(this.transform.position.x - 0.5f, this.transform.position.y, this.transform.position.z), Quaternion.identity);
				go3.GetComponent<Bullet_V2>().dir = FaceDirection.Left;
				break;

			case FaceDirection.Right:
				anim.SetTrigger("RightAttack");
				GameObject go4 = Instantiate(bullet[3], new Vector3(this.transform.position.x + 0.5f, this.transform.position.y, this.transform.position.z), Quaternion.identity);
