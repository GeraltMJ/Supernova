...
public class PlayerSkills : MonoBehaviour {
	...
	public bool cd = false; // 表示当前是否进入技能的CD
	...
	Dictionary<PlayerSkill_Level3, float> skillCD = new Dictionary<PlayerSkill_Level3, float>();
	...
	void Start () {
		...
		skillCD.Add(PlayerSkill_Level3.ShieldSkill, shieldCD);
		skillCD.Add(PlayerSkill_Level3.IceSkill, iceCD);
		skillCD.Add(PlayerSkill_Level3.DoubleDmgSkill, doubleDmgCD);
		skillCD.Add(PlayerSkill_Level3.GunSkill, gunCD);
	...
	void Update () {
		if (skill != PlayerSkill_Level3.Default && ETCInput.GetButtonDown("SkillBtn") && skillCounter < skillCount[skill] && !cd)
		{
			switch (skill)
			{
